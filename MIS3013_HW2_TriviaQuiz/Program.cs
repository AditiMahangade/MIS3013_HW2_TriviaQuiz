...
{
        outMesStr = "You need to type in T or F! Wrong Input! Exit App";
...
double correctRatioDb1 = (q1ScoreInt + q2ScoreInt + q3ScoreInt + q4ScoreInt + q5ScoreInt) / 5.0;
outMesStr = string.Format($"{correctAnswersInt} / 5 are correct! Percentage is {correctRatioDb1:P2}");
Console.WriteLine(outMesStr);
